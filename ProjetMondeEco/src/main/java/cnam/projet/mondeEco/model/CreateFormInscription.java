...
public class CreateFormInscription {
	...
	public static void createPdf(String[] args) {
		...
		String civil = args[2];
		String nom = args[3];
		String prenom = args[4];
		String adresse = args[5];
		String ville = args[6];
		String cp = args[7];
		String diplomeObtenu = args[8];
		String diplomeSouhaite = args[9];
...
//		String dest = "formInscription_" + textDate + ".pdf";
		String dest = args[0];
		try {
			...
			String imFile = "img/logo2.jpeg";
			Image image = Image.getInstance(imFile);
			// Adding image to the document
			/*
			 * You do so by passing the image to the PdfPCell constructor, along with a
			 * boolean saying whether the image should fit the cell (true), or the cell
			 * should fit the image (false).
			 */
			...
			// informations tableau de 2 cellules avec les infos et une cellule pour la
			// photo
...
//			cellPhoto.setBorder(2);
			...
			typeFinancement.add(new Phrase(
					"Type de financement : ......................................................................................................."));
			...
			condition1.add(new Phrase(
					"1 - L’ouverture d’une Formation ou d’une Unité d’Enseignement (UE) est conditionnée par le nombre d’auditeurs."));
			conditions.add(condition1);
			Paragraph condition2 = new Paragraph();
			condition2.setFont(conditionFont);
			condition2
					.add(new Phrase("2 - L’inscription individuelle ne donne pas droit à une attestation de présence"));
			conditions.add(condition2);
			Paragraph condition3 = new Paragraph();
			condition3.setFont(conditionFont);
			condition3.add(new Phrase(
					"3 - Les tarifs applicables par l'école sont susceptibles d’être révisés chaque année universitaire."));
			conditions.add(condition3);
			Paragraph condition4 = new Paragraph();
			condition4.setFont(conditionFont);
			condition4.add(new Phrase(
					"4 - Pour les ressortissants étrangers d’un pays non membre de la communauté européenne, il est nécessaire de fournir une "
