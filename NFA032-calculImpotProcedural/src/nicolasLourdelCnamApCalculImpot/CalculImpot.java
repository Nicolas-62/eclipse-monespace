...
public class CalculImpot {
	...
	public static void main(String[] args) {
		...
		/*
		 * 1. Calcul du quotient familial en fonction du staut marital et du nombre
		 * d'enfants à charge Variables : Tableau des quotients familiaux :
		 * tabQuotientFam[nbEnfants][statut] nbEnfants : nombre d'enfants à charges
		 * statut = 0 : célib, divorcé, veuf statut = 1 : marié ou pacsé
		 */
		...
		// 2. Diviser le revenu net imposable par le nombre de parts du quotient
		// familial
