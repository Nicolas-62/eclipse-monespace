...
public class BoutonObs extends JButton implements MouseListener {
	private String name;
	private Image img;

	public BoutonObs(String str) {
		super(str);
		this.name = str;
		try {
	...
	public void mouseReleased(MouseEvent event) {
		...
		// le clic avec le fichier fondBoutonHover.png si la souris est toujours sur le
		// bouton
