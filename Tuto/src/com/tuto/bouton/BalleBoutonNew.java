...
public class BalleBoutonNew extends JFrame{
	private PanneauDynamique pan = new PanneauDynamique();
	// on ajoute un bouton créé manuellement
	private BoutonBonus bouton = new BoutonBonus("coucou");
	private JPanel container = new JPanel();
	 public BalleBoutonNew(){
		  ...
		  private void go(){  
			...
			System.out.println("hauteur bouton : "+bouton.getHeight());
